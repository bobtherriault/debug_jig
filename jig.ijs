NB. Version 2.0 for this add on - pure SVG

coerase <'jig' NB. clear previous jig variables, helps in updates
...
if. s do. 34;32;'<rect x="15.5" y="7" width="14.39" height="18" stroke="red" fill="white" rx="2"></rect><title> UTF-8 : 0</title></rect><text font-family="',FONT,'" font-size="0.8em" x="18.5" y="20"> </text>' NB. case for s: 0{a.  which has shape 0
      else.tt=. '<title>',(30#'='),(50{.!.B ' Type',B,':',B,typ),(40{.' Shape',B,':',B,(":$y)),(30#'='),'</title>'
...
tt=. '<title>',(30#'='),(50({.!.B)' Sparse',B,(;(1<#2 $. y){'Index : ';'Indices : '),(": 2$.y)),(40{.' Array Shape',B,':',B, (": $ y)),(30#'='),'</title>'
...
if. s do. (19.5 + >./  xw +&, xc);(32 + (18 * ({: ; lit) e. 10;13)+{: ,yc);tm NB. width height character string
    else. tt=. '<title>',(30#'='),(50({.!.B)' Type',B,':',B,'literal',B),(40{.' Shape',B,':',B,(''-:  $ y){::((":  $ y);'atom')),(30#'='),'</title>'
...
if. s do. (21.5+ >./  xw +&, xc);(32 + (18 * ({: ; uni2) e. 10;13)+{: ,yc); tm
    else. tt=. '<title>',(30#'='),(50({.!.B)' Type',B,':',B,'unicode',B),(40{.' Shape',B,':',B,(''-:  $ y){::((":  $ y);'atom')),(30#'='),'</title>'
...
if. s do. (21.5+ >./  xw +&, xc);(32 + (18 * ({: ; uni4) e. 10;13)+{: ,yc); tm
    else. tt=. '<title>',(30#'='),(50({.!.B)' Type',B,':',B,'unicode4',B),(40{.' Shape',B,':',B,'',(''-:  $ y){::((":  $ y);'atom')),(30#'='),'</title>'
         ('<g><rect rx="6" fill="#96C" width="',(": 10.5 + >./  xw +&, xc),'" height="',(": 32 + (18* (-.b) * ({: ; uni4) e. 10;13)+{: ,yc),'" fill-opacity="1"></rect><rect overflow="visible" ');('rx="6" ',(1-: {. $ y){::('stroke="white" fill="#fff"');('fill="#dde" stroke="#aac"'));'" width="';(10.5 + >./  xw +&, xc);'" height="';(32 + (18* (-.b) * ({: ; uni4) e. 10;13)+{: ,yc);'">',tt,'</rect>',anim,'</g>',tm end.
)
...
tt=. '<title>',"1(30#'='),"1(45({.!.B)"1(' Label',B,'Type',B,':',B),"1(;"1 slt),"1' '),"1(50({.!.B)"1(' Index',B,':',B),"1(;"1(":each ,. , 6 s: y))),"1(40{."1(' Total',B,'Symbols',B,'Assigned:',B),"1(": 0 s: 0)),"1(30#'='),"1'</title>'
...
tt=. '<title>',(30#'='),(50({.!.B)' Type :',B,'symbol',B),(40{.' Shape',B,':',B,(''-:  $ y){::((":  $ y);'atom')),(30#'='),'</title>'
...
tt=. '<title>',(30#'='),(50({.!.B)' Type',B,':',B,'boxed',B),(40{.' Shape',B,':',B,(''-:  $ y){::((":  $ y);'atom')),(30#'='),'</title>'
...
tt=. '<title>',(30#'='),(50({.!.B)' Type',B,':',B,'boolean',B),(40{.' Shape',B,':',B,(''-:  $ y){::((":  $ y);'atom')),(30#'='),'</title>'
...
tt=. '<title>',(30#'='),(50({.!.B)' Type',B,':',B,'integer',B),(40{.' Shape',B,':',B,(''-:  $ y){::((":  $ y);'atom')),(30#'='),'</title>'
...
tt=. '<title>',(30#'='),(50({.!.B)' Type',B,':',B,'extended',B),(40{.' Shape',B,':',B,(''-:  $ y){::((":  $ y);'atom')),(30#'='),'</title>'
...
tt=. '<title>',(30#'='),(50({.!.B)' Type',B,':',B,'floating',B),(40{.' Shape',B,':',B,(''-:  $ y){::((":  $ y);'atom')),(30#'='),'</title>'
...
tt=. '<title>',(30#'='),(50({.!.B)' Type',B,':',B,'rational',B),(40{.' Shape',B,':',B,(''-:  $ y){::((":  $ y);'atom')),(30#'='),'</title>'
...
tt=. '<title>',(30#'='),(50({.!.B)' Type',B,':',B,'complex',B),(40{.' Shape',B,':',B,(''-:  $ y){::((":  $ y);'atom')),(30#'='),'</title>'
